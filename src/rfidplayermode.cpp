...
void RfidPlayerMode::setup() {
	...
	this->app = new App(this->leds, this->tagscanner, this->player, this->settings, this->bluetoothsource, this->equalizer, this->playstatemonitor);
